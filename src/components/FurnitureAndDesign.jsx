...
const FurnitureAndDesign = ({ setHoveredId, hoveredId, disableHover, setDisableHover, clickedId, setClickedId }) => {

    return (
        <>
            <Title>Make your space move-in-ready</Title>
            <SubTitle>Furniture &amp; Design</SubTitle>
            <Discription>Which furniture package fits you best?</Discription>
...
export default FurnitureAndDesign
